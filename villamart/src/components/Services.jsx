...
export default function Services({ services }) {
  return (
    ...
    >
      ...
      <section className="w-full flex justify-between items-center md:h-[85vh] h-[115vh] ">
        <Zoom clear>
        ...
        <div className=" w-full md:w-[49%]  h-full flex flex-col justify-between items-center">
          <Fade top distance={"20%"}>
            <div className=" w-full h-[31%] md:h-[30%] rounded-[0.45rem]   shadower flex items-center justify-center ">
              <div className=" w-[50%] h-full rounded-r-[0.45rem] px-2">
                ...
                <p className=" text-gray-500 text-sm md:text-[1.1rem]">
                  We pride ourselves on offering a wide selection of
                  high-quality, fresh produce and pantry staples at affordable
                  prices. We're your one-stop-shop for all your grocery needs!
                </p>
              </div>
              <img
            ...
            <div className=" w-full h-[31%] md:h-[30%] rounded-[0.45rem]   shadower flex items-center justify-center ">
              <div className=" w-[50%] h-full rounded-r-[0.45rem] px-2">
                ...
                <p className=" text-gray-500 text-sm md:text-[1.1rem]">
                  Whether you're hosting a wedding, birthday party, or any
                  special event, our catering service can help you create an
            ...
            <div className=" w-full h-[31%] md:h-[30%] rounded-[0.45rem]   shadower flex items-center justify-center ">
              <div className=" w-[50%] h-full rounded-r-[0.45rem] px-2">
                ...
                <p className=" text-gray-500 text-sm md:text-[1.1rem]">
                  Don't have time to go grocery shopping? No problem! Our
                  grocery delivery service makes it easy to stock up on
                  everything you need without ever leaving your home.
                </p>
              </div>
              <img
