  ...
  return (
    <main className="max-w-7xl mt-[2.5rem] md:mt-[3.5rem] mx-auto px-2 md:px-0">
      ...
      <section className="w-full flex justify-between flex-wrap items-center h-[70vh] ">
        ...
        <div className="w-full md:w-[49%] md:h-full h-[80%] flex flex-col justify-center md:justify-between items-center  shadow md:p-4">
          ...
          <p className=" text-gray-500 text-[1rem] hidden md:block mt-6 md:mt-0">
          ...
          <p className=" text-gray-500 text-[1rem] mt-2 md:mt-0">
